...
def build_canonical_opportunity_evaluation(
    *,
    ...
    evaluation_evidence = {
        ...
        "domain_key": evidence_scores["evidence"].get("domain_key", ""),
        "workflow_cluster_key": evidence_scores["evidence"].get("workflow_cluster_key", ""),
        "retrieval_strategy_key": evidence_scores["evidence"].get("retrieval_strategy_key", ""),
        "corroboration_strategy_key": evidence_scores["evidence"].get("corroboration_strategy_key", ""),
        ...
        "query_origin_counts": corroboration.get("query_origin_counts", evidence_scores["evidence"].get("query_origin_counts", {})),
        "attribution_scope_counts": corroboration.get(
            "attribution_scope_counts",
            evidence_scores["evidence"].get("attribution_scope_counts", {}),
        ),
        "origin_scope_counts": corroboration.get("origin_scope_counts", evidence_scores["evidence"].get("origin_scope_counts", {})),
        "finding_specific_match_count": corroboration.get(
            "finding_specific_match_count",
            evidence_scores["evidence"].get("finding_specific_match_count", 0),
        ),
        "cluster_only_match_count": corroboration.get(
            "cluster_only_match_count",
            evidence_scores["evidence"].get("cluster_only_match_count", 0),
        ),
        "generic_domain_match_count": corroboration.get(
            "generic_domain_match_count",
            evidence_scores["evidence"].get("generic_domain_match_count", 0),
        ),
        "comparison_sibling_finding_id": corroboration.get(
            "comparison_sibling_finding_id",
            evidence_scores["evidence"].get("comparison_sibling_finding_id", 0),
        ),
        "comparison_sibling_validation_id": corroboration.get(
            "comparison_sibling_validation_id",
            evidence_scores["evidence"].get("comparison_sibling_validation_id", 0),
        ),
        "comparison_sibling_domain_key": corroboration.get(
            "comparison_sibling_domain_key",
            evidence_scores["evidence"].get("comparison_sibling_domain_key", ""),
        ),
        "comparison_sibling_strategy_key": corroboration.get(
            "comparison_sibling_strategy_key",
            evidence_scores["evidence"].get("comparison_sibling_strategy_key", ""),
        ),
        "comparison_scope": corroboration.get("comparison_scope", evidence_scores["evidence"].get("comparison_scope", "")),
        "query_overlap_ratio": corroboration.get(
            "query_overlap_ratio",
            evidence_scores["evidence"].get("query_overlap_ratio", 0.0),
        ),
        "matched_url_overlap_ratio": corroboration.get(
            "matched_url_overlap_ratio",
            evidence_scores["evidence"].get("matched_url_overlap_ratio", 0.0),
        ),
        "shared_query_count": corroboration.get(
            "shared_query_count",
            evidence_scores["evidence"].get("shared_query_count", 0),
        ),
        "shared_matched_url_count": corroboration.get(
            "shared_matched_url_count",
            evidence_scores["evidence"].get("shared_matched_url_count", 0),
        ),
        "compression_signal": corroboration.get(
            "compression_signal",
            evidence_scores["evidence"].get("compression_signal", "none"),
        ),
    ...
    return build_opportunity_evaluation(
        ...
        corroboration_inputs={
            ...
            "retrieval_strategy_key": evidence_scores["evidence"].get("retrieval_strategy_key", ""),
            "corroboration_strategy_key": evidence_scores["evidence"].get("corroboration_strategy_key", ""),
            "query_origin_counts": corroboration.get("query_origin_counts", {}),
            "attribution_scope_counts": corroboration.get("attribution_scope_counts", {}),
            "origin_scope_counts": corroboration.get("origin_scope_counts", {}),
            "comparison_sibling_finding_id": int(corroboration.get("comparison_sibling_finding_id", 0) or 0),
            "comparison_sibling_validation_id": int(corroboration.get("comparison_sibling_validation_id", 0) or 0),
            "comparison_sibling_domain_key": str(corroboration.get("comparison_sibling_domain_key", "") or ""),
            "comparison_sibling_strategy_key": str(corroboration.get("comparison_sibling_strategy_key", "") or ""),
            "comparison_scope": str(corroboration.get("comparison_scope", "") or ""),
            "query_overlap_ratio": float(corroboration.get("query_overlap_ratio", 0.0) or 0.0),
            "matched_url_overlap_ratio": float(corroboration.get("matched_url_overlap_ratio", 0.0) or 0.0),
            "shared_query_count": int(corroboration.get("shared_query_count", 0) or 0),
            "shared_matched_url_count": int(corroboration.get("shared_matched_url_count", 0) or 0),
            "compression_signal": str(corroboration.get("compression_signal", "none") or "none"),
            "requested_specific_queries": int(evidence_scores["evidence"].get("requested_specific_queries", 2) or 0),
            "generated_specific_queries": int(evidence_scores["evidence"].get("generated_specific_queries", 0) or 0),
            "executed_specific_queries": int(evidence_scores["evidence"].get("executed_specific_queries", 0) or 0),
            "strategy_pack_query_count": int(evidence_scores["evidence"].get("strategy_pack_query_count", 0) or 0),
        },
...
def build_evidence_payload(
    *,
    ...
    return {
        ...
        "query_plan": evidence_scores["evidence"].get("query_plan", []),
        "requested_specific_queries": evidence_scores["evidence"].get("requested_specific_queries", 2),
        "generated_specific_queries": evidence_scores["evidence"].get("generated_specific_queries", 0),
        "executed_specific_queries": evidence_scores["evidence"].get("executed_specific_queries", 0),
        "strategy_pack_query_count": evidence_scores["evidence"].get("strategy_pack_query_count", 0),
