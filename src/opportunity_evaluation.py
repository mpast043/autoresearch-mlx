    ...
    *,
    ...
    return {
        ...
        "evidence": {
            ...
            "domain_key": str(evidence.get("domain_key", "") or ""),
            "workflow_cluster_key": str(evidence.get("workflow_cluster_key", "") or ""),
            "retrieval_strategy_key": str(evidence.get("retrieval_strategy_key", "") or ""),
            ...
            "query_origin_counts": dict(evidence.get("query_origin_counts", {}) or {}),
            "attribution_scope_counts": dict(evidence.get("attribution_scope_counts", {}) or {}),
            "origin_scope_counts": dict(evidence.get("origin_scope_counts", {}) or {}),
            "finding_specific_match_count": int(evidence.get("finding_specific_match_count", 0) or 0),
            "cluster_only_match_count": int(evidence.get("cluster_only_match_count", 0) or 0),
            "generic_domain_match_count": int(evidence.get("generic_domain_match_count", 0) or 0),
            "comparison_sibling_finding_id": int(evidence.get("comparison_sibling_finding_id", 0) or 0),
            "comparison_sibling_validation_id": int(evidence.get("comparison_sibling_validation_id", 0) or 0),
            "comparison_sibling_domain_key": str(evidence.get("comparison_sibling_domain_key", "") or ""),
            "comparison_sibling_strategy_key": str(evidence.get("comparison_sibling_strategy_key", "") or ""),
            "comparison_scope": str(evidence.get("comparison_scope", "") or ""),
            "query_overlap_ratio": float(evidence.get("query_overlap_ratio", 0.0) or 0.0),
            "matched_url_overlap_ratio": float(evidence.get("matched_url_overlap_ratio", 0.0) or 0.0),
            "shared_query_count": int(evidence.get("shared_query_count", 0) or 0),
            "shared_matched_url_count": int(evidence.get("shared_matched_url_count", 0) or 0),
            "compression_signal": str(evidence.get("compression_signal", "none") or "none"),
